    ...
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>
            While the initial creators of the Chill protocol have made
      ...
      return (
        <div>
          <p>Attention CHILL Uniswap LPs</p>
          <p>
            The only Uniswap pool that is compatible with CHILL is CHILL/yCRV
            (Curve yPool tokens)
          </p>
