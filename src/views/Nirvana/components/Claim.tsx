...
const Claim: React.FC<ClaimProps> = ({ pid, name, iconSrc }) => {
  ...
  useEffect(() => {
    async function process() {
      ...
      let trasferBalancePercent = new BigNumber(userAmount).multipliedBy(new BigNumber(1e18)).div(new BigNumber(totalPoolBalance))
      ...
      const transferBalance = trasferBalancePercent.multipliedBy(new BigNumber(rewardAmount)).div(new BigNumber(1e18)) 
      // }
